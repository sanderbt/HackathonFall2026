// This view runs in a frame of its own: no platform elements are registered in it. The platform's
// design tokens are set on :root, so var(--text-default) still resolves.
